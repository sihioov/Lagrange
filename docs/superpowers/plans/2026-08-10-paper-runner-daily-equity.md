...
- [ ] **Step 1: Write the failing worker-scan test.**
...
- [ ] **Step 3: Implement the minimal worker DTO/query.**
...
- [ ] **Step 3: Implement typed valuation errors and account loading.**
...
- [ ] **Step 4: Implement close loading and future-close guard.**
...
- [ ] **Step 5: Apply the portfolio event and persist atomically.**
...
- [ ] **Step 3: Implement service and report types.**
...
- [ ] **Step 4: Implement target execution using the existing seam.**
...
- [ ] **Step 5: Implement account valuation in the same cycle.**
...
- [ ] **Step 6: Run the focused cycle test and existing seams.**
...
- [ ] **Step 3: Implement the binary contract.**
...
- [ ] **Step 4: Run CLI and compile tests.**
...
- [ ] **Step 2: Run the existing workspace gates.**

Run the repository's documented Rust, Python, web, and `openapi:check` commands from `docs/STATUS.md` after the focused suites pass. Do not run a gate concurrently with an in-progress edit.
