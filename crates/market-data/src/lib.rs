...
pub use range_to_canonical::{
    ...
    HISTORICAL_PRICE_ONLY_CASH_DIVIDEND_TREATMENT, HistoricalPriceOnlyBetaInput,
    HistoricalPriceOnlyBetaPins, HistoricalPriceOnlyIgnoredCashDividendEvidence,
    HistoricalPriceOnlySessionWitness, NON_STRICT_PIT_POLICY_ID, RANGE_CANONICAL_BRIDGE_VERSION,
    REQUIRED_ACTION_KINDS, RangeAction, RangeCanonicalBarCandidate, RangeCanonicalCandidate,
