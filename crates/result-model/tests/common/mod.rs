...
pub fn golden_result() -> BacktestResult {
    ...
    // equity/cash ground truth (scale-4), open-of-day equity + close-of-day cash.
    let equity_days = [
        ("2020-01-01", 10_000_000_000_i128, 10_000_000_000_i128),
        ("2020-01-02", 9_999_500_000, 7_999_500_000),
        ("2020-01-03", 9_998_900_000, 4_998_900_000),
        ("2020-01-06", 9_998_400_000, 1_998_400_000),
        ("2020-01-09", 10_098_000_000, 3_048_000_000),
        ("2020-01-14", 10_022_430_000, 5_972_430_000),
        ("2020-01-16", 9_921_987_000, 8_871_987_000),
    ];
