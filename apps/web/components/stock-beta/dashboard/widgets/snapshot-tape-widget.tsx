...
export function SnapshotTapeWidget({
  ...
  const { copy: t, data, locale } = viewModel;
  const leaders = "top5" in data ? data.top5 : data.rows.slice(0, 5);
  const scopeLabel = "top5" in data ? t.topFiveHeading : t.currentResultLeadersHeading;
