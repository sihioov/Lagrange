...
through `0047`, then runs `research-schema-check` as a fail-closed one-shot.
The worker is not launched unless that gate finds successful migrations
`22–25`, `33–35`, `42`, and `45–47` (the research schema versions it checks), exact normalized
